...
sealed class Destinations(
    ...
    object Pantalla2: Destinations("pantalla2/?category={category}&amount={amount}", "Pantalla 2", Icons.Filled.Settings) {
        fun createRoute(category: String,amount: Int) = "pantalla2/?category=$category&amount=$amount"
    }
    object Pantalla3: Destinations("SettingsScreen", "Pantalla 3", Icons.Filled.Favorite)
}
